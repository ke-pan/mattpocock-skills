...
- Do not verify by rewriting: you read, run read-only commands (diffs, log, targeted test invocations when asked), and report. You never edit files and never spawn further agents.
